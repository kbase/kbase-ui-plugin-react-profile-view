...
"National Renewabl Energy Laboratory (NREL)",
...
const heigherEd = [
    ...
    "California College San Diego - San Marcos",
    ...
    "Columbia College - MO",
    "Columbia College - SC",
    "Columbia College - Vienna",
    "Columbia College - Centreville",
    ...
    "Interactive College of Technology - Pasadena",
    ...
    "McCann School of Business & Technology - Dickson City",
    "McCann School of Business & Technology - Shreveport",
    ...
    "Spartan College of Aeronautics and Technology -Broomfield",
    ...
    "Yuba College,Zane State College"
    ]
    
    export const institution = NationalLabs.concat(heigherEd);
